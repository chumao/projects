    ...
    */
    $.fn.lightBox = function(settings) {
        ...
        settings = jQuery.extend({
            ...
            imageBtnPrev: 'http://s.syyx.com/nycs/plugin/light-box/img/lightbox-btn-prev.gif', 		// (string) Path and the name of the prev button image
            imageBtnNext: 'http://s.syyx.com/nycs/plugin/light-box/img/lightbox-btn-next.gif', 		// (string) Path and the name of the next button image
        ...
        */
        function _show_image_data() {
            ...
            if (settings.imageArray.length > 1) {
                $('#lightbox-image-details-currentNumber').html(settings.txtImage + ' ' + (settings.activeImage + 1) + ' ' + settings.txtOf + ' ' + settings.imageArray.length + ' 张&nbsp;<a target=\"_blank\" style=\"text-decoration: underline;color:#666666\" href=\"' + settings.imageArray[settings.activeImage][0] + '\">查看原图</a>').show();
            }
        }
        /**
